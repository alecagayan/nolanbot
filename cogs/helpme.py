    ...
    async def helpme(self, ctx, tag = None):
        ...
        if(tag == 'sticker'):
            ...
            await ctx.send("As a Donut Underground member, many perks await you. You get to chat in this server along with getting behind the scenes videos, a merch discount, loyalty badges and emojis, and an exclusive sticker mailed every 3 months!")
                ...
                embed.add_field(name='sticker', value=None, inline=True)
                embed.add_field(name='order', value=None, inline=True)
                embed.add_field(name='membership', value=None, inline=True)
                embed.add_field(name='donut', value=None, inline=True)
                embed.add_field(name='server', value=None, inline=True)
                embed.add_field(name='perks', value=None, inline=True)
